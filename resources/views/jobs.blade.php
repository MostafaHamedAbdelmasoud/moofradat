...
<br>
<br>
            <form action="{{ url('/jobrequest') }}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        ...
                        <div class="form-group">
                             ...
                             <label class="form-group border-lable-flt">
                            <input type="text" name="msg_title" class="form-control" placeholder="الغرض من التواصل">
                             <span style="color:black;">الغرض من التواصل</span>
                            </label>
                        </div>
                            <div class="form-group">
                            ...
                            <select name="job" class="form-control">
                                @if($jobs)
                                    ...
                                    @endforeach
                                @else
                                    <option value="">لا يوجد وظائف</option>
                                @endif
                            </select>
                              <span style="color:black;">نوع الوظيفة</span>
                            </label>
                        </div>
  <div class="form-group">
                             <label class="form-group border-lable-flt">
