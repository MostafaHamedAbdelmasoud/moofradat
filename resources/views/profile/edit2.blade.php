...
@section('extraCss')
    <link rel="stylesheet"
          href="https://cdnjs.cloudflare.com/ajax/libs/imgareaselect/0.9.10/css/imgareaselect-default.css">
    <style>
                    ...
                    <form method="post" enctype="multipart/form-data"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <br>
                                <p class="text-center"><img id="preview-profile-pic" style="display:none;"/></p>
                                <br>

                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">إغلاق</button>
                                <button type="submit" id="save_crop" class="btn btn-primary">إعتماد الصورة</button>
                            </div>
                        </div>
                    </form>
                </div>
...
@section('extraJS')
    ...
    <script>
        $(document).ready(function () {
            ...
            var preview_profile = $('#preview-profile-pic');
            $(document).on('change', '#profile-pic', function (a) {

                var imageReader = new FileReader();
                imageReader.readAsDataURL($('#profile-pic')[0].files[0]);
                //console.log($('#profile-pic')[0].files[0]);
                imageReader.onload = function (oFREvent) {
                    //console.log(oFREvent.target.result);
                    preview_profile.attr('src', oFREvent.target.result).fadeIn();
                };
            });

            $('#preview-profile-pic').imgAreaSelect({
                handles: true,
