        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet blue box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-settings"></i>تعديل إختصار
                    </div>
                </div>
                <div class="portlet-body form">
                    <form role="form" method="post"
                          action="{{ url('ipanel/shortcuts/update',$shortcut->id) }}">
                        {{ csrf_field() }}
                        <div class="form-body">

                            <div class="form-group">
                                <label>الإختصار</label>
                                <div class="input-group">
                                                        <span class="input-group-addon input-circle-left">
                                                            <i class="fa fa-globe"></i>
                                                        </span>
                                    <input type="text" class="form-control input-circle-right"
                                           placeholder="أدخل الإختصار" name="shortcut"
                                           value="{{ (old('shortcut')) ? old('shortcut') : $shortcut->shortcut }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>الإخصار كامل</label>
                                <div class="input-group">
                                                        <span class="input-group-addon input-circle-left">
                                                            <i class="fa fa-globe"></i>
                                                        </span>
                                    <input type="text" class="form-control input-circle-right"
                                           placeholder="أدخل الإختصار كامل" name="mean"
                                           value="{{ (old('mean')) ? old('mean') : $shortcut->mean }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>المعنى</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input-circle-right"
                                           placeholder="أدخل المعنى" name="translation"
                                           value="{{ (old('translation')) ? old('translation') : $shortcut->translation }}">
                                </div>
                            </div>
                            ...
                            @if(Auth::user()->roles[0]->id != 3)
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="0" {{ ($shortcut->status == 0) ? 'selected="selected"' : '' }}>
                                            قيد
                                            الإنتظار
                                        </option>
                                        <option value="1" {{ ($shortcut->status == 1) ? 'selected="selected"' : '' }}>
                                            مقبولة
                                        </option>
                                        <option value="2" {{ ($shortcut->status == 2) ? 'selected="selected"' : '' }}>
                                            مرفوضة
                                        </option>
                                    </select>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <textarea class="form-control"
                                                          name="note"
                                                          rows="6"> {{ (old('note')) ? old('note') : $shortcut->note }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control"
                                                          name="note"
                                                          rows="6" readonly="readonly"> {{ $shortcut->note }}</textarea>
