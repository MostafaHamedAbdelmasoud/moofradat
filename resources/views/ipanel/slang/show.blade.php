        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet blue box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-settings"></i>إضافة الكلمة/جملة
                    </div>
                </div>
                <div class="portlet-body form">
                    <form role="form" method="post"
                          action="{{ url('ipanel/slang/update',$slang->id) }}">
                        {{ csrf_field() }}
                        <div class="form-body">

                            <div class="form-group">
                                <label>الجملة/الكلمة</label>
                                <div class="input-group">
                                                        <span class="input-group-addon input-circle-left">
                                                            <i class="fa fa-globe"></i>
                                                        </span>
                                    <input type="text" class="form-control input-circle-right"
                                           placeholder="أدخل الجملة/الكلمة" name="sentence"
                                           value="{{ (old('sentence') ) ? old('sentence') : $slang->sentence}}">
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <textarea class="wysihtml5 form-control" rows="6"
                                                          name="translation">{{ (old('translation')) ? old('translation') : $slang->translation }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if(Auth::user()->roles[0]->id != 3)
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="0" {{ ($slang->status == 0) ? 'selected="selected"' : '' }}>قيد
                                            الإنتظار
                                        </option>
                                        <option value="1" {{ ($slang->status == 1) ? 'selected="selected"' : '' }}>
                                            مقبولة
                                        </option>
                                        <option value="2" {{ ($slang->status == 2) ? 'selected="selected"' : '' }}>
                                            مرفوضة
                                        </option>
                                    </select>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <textarea class="form-control"
                                                          name="note"
                                                          rows="6"> {{ (old('note')) ? old('note') : $slang->note }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control"
                                                          name="note"
                                                          rows="6" readonly="readonly"> {{ $slang->note }}</textarea>
