            ...
            <div class="portlet blue box">
                ...
                <div class="portlet-body form">
                    <form role="form" method="post"
                          action="{{ url('/ipanel/medical/update', $term->id) }}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input-circle-right"
                                           ...
                                           value="{{ (old('title')) ? old('title') : $term->title }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input-circle-right"
                                           ...
                                           value="{{ (old('translation')) ? old('translation') : $term->translation }}">
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="wysihtml5 form-control"
                                                          name="example"
                                                          rows="6"> {{ (old('example')) ? old('example') : $term->example }}</textarea>
                            ...
                            @if(Auth::user()->roles[0]->id != 3)
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="0" {{ ($term->status == 0) ? 'selected="selected"' : '' }}>قيد
                                            الإنتظار
                                        </option>
                                        <option value="1" {{ ($term->status == 1) ? 'selected="selected"' : '' }}>
                                            مقبولة
                                        </option>
                                        <option value="2" {{ ($term->status == 2) ? 'selected="selected"' : '' }}>
                                            مرفوضة
                                        </option>
                                    </select>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <textarea class="form-control"
                                                          name="note"
                                                          rows="6"> {{ (old('note')) ? old('note') : $term->note }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control"
                                                          name="note"
                                                          rows="6" readonly="readonly"> {{ $term->note }}</textarea>
