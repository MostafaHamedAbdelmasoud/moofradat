            ...
            <div class="portlet blue box">
                ...
                <div class="portlet-body form">
                    <form role="form" method="post" enctype="multipart/form-data"
                          action="{{ url('ipanel/users/update', $user->id) }}">
                        {{ csrf_field() }}
                        <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="verifed">
                                            <option value="0" {{ ($user->verifed == 0) ? 'selected="selected"' : '' }}>
                                                غير فعال
                                            </option>
                                            <option value="1" {{ ($user->verifed == 1) ? 'selected="selected"' : '' }}>
                                                فعال
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="blue_mark">
                                            <option value="0" {{ ($user->blue_mark == 0) ? 'selected="selected"' : '' }}>
                                                لا
                                            </option>
                                            <option value="1" {{ ($user->blue_mark == 1) ? 'selected="selected"' : '' }}>
                                                نعم
                                            </option>
                                        </select>
                                    </div>
