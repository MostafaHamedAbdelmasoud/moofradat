        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet blue box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-settings"></i> تعديل بيانات صفحة
                    </div>
                </div>
                <div class="portlet-body form">
                    <form role="form" method="post"
                          action="{{ url('ipanel/pages/update/'.$page->id) }}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input-circle-right"
                                           placeholder="أدخل عنوان الصفحة" name="title"
                                           value="{{ $page->page_title }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea class="summernote" id="summernote_1"
                                              name="content"> {{ $page->page_content }}</textarea>
                                </div>
                            </div>
